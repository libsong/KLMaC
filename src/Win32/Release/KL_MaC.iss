...
;Source: shell32.dll; DestDir: "{app}"; Flags: ignoreversion
;Source: kernel32.dll; DestDir: "{app}"; Flags: ignoreversion
;Source: user32.dll; DestDir: "{app}"; Flags: ignoreversion
...
;Source: IPHLPAPI.dll; DestDir: "{app}"; Flags: ignoreversion                     
